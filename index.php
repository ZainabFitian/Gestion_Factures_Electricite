...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="nav-list">
            ...
            <a href="#nos-chiffres" class="nav-link">Nos Chiffres</a>
    ...
    <div class="container">
        ...
        <section class="section-1" id="home">
            <div class="banner">
                ...
                <button class="banner-btn"><a style="color:white;" href="Login.php">Login</a></button>
            </div>
        </section>
        <!-- End of Section 1 -->
        ...
        <footer class="footer">
            <div class="footer-nav">
                <a href="#home">Home</a>
                <a href="#nos-chiffres">Nos Chiffres</a>
