...
<body>
 ...
 <nav class="navbar">
	...
	<h1>Réclamations</h1>
        ...
        include_once('Fournisseur-Reclamations-Navigation.php');
        ...
        $statement = "`reclamation` ORDER BY `IdReclamation` ASC";
        $stmt = $con->prepare("SELECT * FROM reclamation ORDER BY IdReclamation DESC LIMIT {$startpoint} , {$per_page}");
        $stmt->execute();
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			...
			<td align="center">
			<a   href="Fournisseur-Reclamations-Repondre.php?enumContrat=<?php echo $row['NumContrat']; ?>" title="Repondre">
