...
<body>
 ...
 <nav class="navbar">
    ...
    <center>
        <a id="ajouter" href="Fournisseur-GererClient-Ajouter.php"><button>Ajouter Client</button></a>
        ...
        include_once('Fournisseur-GererClients-Navigation.php');
        ...
        $statement = "`client` ORDER BY `NumContrat` ASC";


        $stmt = $con->prepare("SELECT * FROM client ORDER BY NumContrat DESC LIMIT {$startpoint} , {$per_page}");
        $stmt->execute();
